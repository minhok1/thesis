## Source code From https://github.com/hyeonjames/torch-radam/blob/master/radam.py
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if momentum2_coeff != 0:
                    p_data_fp32.addcdiv_(-lr * momentum1_coeff * momentum2_coeff, exp_avg,
